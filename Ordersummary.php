      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread"><mark></mark></h1>
          </div>
        </div>
      </div>
    </div> -->
  ...
  <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          ...
          <div class="col-sm-13 ftco-animate text-center">
                <h2 class="subheading mb-4"><font color="red"><b><mark>Order Summery</mark></b></font></h2>
                <p><a href="Ordersummary.php" class="btn btn-primary">View Details</a></p>
              </div>
        </div>
      </div>
    </div>
