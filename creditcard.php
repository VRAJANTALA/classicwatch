  ...
  <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          ...
          <div class="col-sm-13 ftco-animate text-center">
                <h2 class="subheading mb-4"><font color="red"><b><mark>Credit Card</mark></b></font></h2>
                <p><a href="creditcard.php" class="btn btn-primary">View Details</a></p>
              </div>
        </div>
      </div>
    </div>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-xl-7 ftco-animate">
						<form action="#" class="billing-form">
							<h3 class="mb-4 billing-heading"><b>CreditCard Details</b></h3>
