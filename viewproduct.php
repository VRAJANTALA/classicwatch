            ...
            <h1 class="mb-0 bread"><mark>Profile Page</mark></h1>
 				...
 				<div class="col-sm-13 ftco-animate text-center">
 					<h2 class="subheading mb-4">
 						<font color="red"><b><mark>View Product</mark></b></font>
 					</h2>
 				</div>
 			</div>
 		</div>
 					...
 					<?php
						...
						?>
 							...
 							<div class="col-lg-6 product-details pl-md-5 ftco-animate">
 								...
 								<p>
 									<input type="submit" name="addcart" value="Add to Cart" class="btn btn-black py-3 px-5">
 			...
 			<div class="row">
 				<div class="col-md-12 text-center">
 					...
 					<p>
 						...
 						</script> All rights reserved | This template is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="" target="_blank">CLASSIC WATCH</a>
